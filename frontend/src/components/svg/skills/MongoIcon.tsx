...
export const MongoIcon: FC = () => {
    return (
        ...
        >
            <path
                className="fill-gray-400 group-hover:fill-[#378828] transition duration-500"
            ...
            />
            <path
                className="group-hover:fill-[#46a438] transition duration-500"
            ...
            />
            <path
                className="group-hover:fill-[#92775d] transition duration-500"
